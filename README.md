...
A short guide on forking and creating a pull request can be found here: [contributing](https://github.com/xbmc/repo-skins/blob/master/CONTRIBUTING.md).
...
* [Add-on rules](https://github.com/xbmc/repo-skins/blob/master/CONTRIBUTING.md)
